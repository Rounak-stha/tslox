...
export default function Footer() {
    return (
        <div className="h-6 text-xs mono flex items-center justify-center text-blue-600">
            <a href="https://github.com/rounak-stha/tslox/issues">
            ...
            <a href="https://github.com/rounak-stha/tslox">
            ...
            <a href="https://www.rounakstha.me">
