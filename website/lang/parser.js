...
export const parser = LRParser.deserialize({
  ...
  skippedNodes: [0,1],
  repeatNodeCount: 1,
  tokenData: "%i~R^XY}YZ}]^}pq}rs!`st#|xy$[yz$a}!O$f!P!Q$z!Q![$f!c!}$f#R#S$f#T#o$f~!SS`~XY}YZ}]^}pq}~!cVOr!`rs!xs#O!`#O#P!}#P;'S!`;'S;=`#v<%lO!`~!}OS~~#QRO;'S!`;'S;=`#Z;=`O!`~#^WOr!`rs!xs#O!`#O#P!}#P;'S!`;'S;=`#v;=`<%l!`<%lO!`~#yP;=`<%l!`~$PQ#Y#Z$V#h#i$V~$[OT~~$aOV~~$fOU~~$kTR~}!O$f!Q![$f!c!}$f#R#S$f#T#o$f~$}P!P!Q%Q~%VSP~OY%QZ;'S%Q;'S;=`%c<%lO%Q~%fP;=`<%l%Q",
  tokenizers: [0],
